 ...
 *
 * This is a CJS wrapper that imports the ESM modules
 */

import { generatePuzzle } from '../dist/lib/puzzle-generator.js';
import { validatePuzzleGrid } from '../dist/lib/puzzle-validator.js';
...
function generatePuzzlesFile(puzzles) {
  const lines = [
    ...
    ' * Generated automatically by scripts/generate-puzzles.js',
