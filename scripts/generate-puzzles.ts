/**
 * Script to pre-generate 3 puzzles per level (L1-L3)
 * Outputs to src/data/puzzles.ts
 *
 * Run with: npx ts-node scripts/generate-puzzles.ts
 * Or add to package.json: "scripts": { "generate-puzzles": "ts-node scripts/generate-puzzles.ts" }
 */

import { generatePuzzle } from '../src/lib/puzzle-generator';
import { validatePuzzleGrid } from '../src/lib/puzzle-validator';
 ...
 */
function generateAllPuzzles(): PuzzleMeta[] {
 ...
 */
function generatePuzzlesFile(puzzles: PuzzleMeta[]): string {
  const lines: string[] = [
    '/**',
    ' * Pre-generated Sudoku puzzles for levels 1-3',
    ' * Generated automatically by scripts/generate-puzzles.ts',
