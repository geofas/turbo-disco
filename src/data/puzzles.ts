...
export const PUZZLES: PuzzleMeta[] = [
  {
    ...
    grid: [[3,4,1,6,0,2,7,0,8],[0,9,0,0,4,1,0,0,2],[0,0,2,0,0,8,3,4,1],[0,1,3,0,2,0,9,0,0],[5,0,6,9,8,7,4,0,3],[0,0,7,0,1,0,5,2,0],[1,3,4,2,0,0,8,0,0],[2,0,0,8,7,0,0,3,0],[8,0,9,1,0,4,2,6,5]],
  ...
  },
  {
    ...
    grid: [[8,0,9,0,0,4,7,0,6],[0,2,0,0,7,6,8,0,9],[0,1,6,5,0,0,3,0,4],[5,9,0,0,2,0,0,0,7],[0,4,3,6,1,7,5,9,0],[1,0,0,0,5,0,0,4,3],[4,0,2,0,0,1,9,8,0],[9,0,5,3,4,0,0,7,0],[6,0,1,8,0,0,4,0,2]],
  ...
  },
  {
    ...
    grid: [[0,7,9,5,0,0,0,6,0],[5,4,1,0,6,2,0,0,0],[3,0,6,8,9,7,0,1,4],[0,8,7,0,0,5,0,2,3],[0,3,2,9,7,8,1,4,0],[1,5,0,6,0,0,9,7,0],[4,1,0,2,3,6,7,0,9],[0,0,0,4,5,0,2,3,6],[0,6,0,0,0,9,4,5,0]],
    ...
    filledCells: 49,
    techniques: ["fullHouse","nakedSingle"],
    difficulty: 50
  },
  {
    id: "L2-001",
    ...
    grid: [[0,0,5,0,0,0,0,0,6],[0,0,8,5,3,9,7,0,0],[2,0,7,8,4,0,0,0,0],[8,0,6,9,0,0,0,7,0],[0,3,9,0,7,0,6,8,0],[0,2,0,0,0,4,9,0,3],[0,0,0,0,9,5,2,0,7],[0,0,3,2,1,7,4,0,0],[1,0,0,0,0,0,3,0,0]],
    solution: [[3,9,5,7,2,1,8,4,6],[4,6,8,5,3,9,7,2,1],[2,1,7,8,4,6,5,3,9],[8,4,6,9,5,3,1,7,2],[5,3,9,1,7,2,6,8,4],[7,2,1,6,8,4,9,5,3],[6,8,4,3,9,5,2,1,7],[9,5,3,2,1,7,4,6,8],[1,7,2,4,6,8,3,9,5]],
    filledCells: 35,
    techniques: ["fullHouse","hiddenSingle","nakedSingle"],
    difficulty: 50
  },
