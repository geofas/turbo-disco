      ...
      <section className="container-sudoku py-16">
        <div className="mb-12">
          ...
          <p className="text-lg text-gray-700">
            Master Sudoku techniques from beginner to expert. Each level teaches one technique, then
            you practice.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6">
          {levels.map(item => {
            const isComingSoon = item.level >= 4;
            const unlocked = !isComingSoon && isLevelUnlocked(item.level);
                ...
                style={{
                  backgroundColor: isComingSoon
                    ...
                    : unlocked
                      ? 'white'
                      : 'var(--color-neutral-light)',
                  opacity: isComingSoon ? 0.5 : unlocked ? 1 : 0.6,
                  border: `2px solid ${
                    isComingSoon
                      ? 'var(--color-neutral-light)'
                      : unlocked
              ...
              >
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    {isComingSoon ? (
                      <div className="text-lg" title="Coming Soon">
                        ⏰
                      </div>
                    ) : (
                      !unlocked && (
                  ...
                  {unlocked && (
                    <div className="space-y-2 text-sm">
                      {lessonCompleted ? (
                        ...
                        <div style={{ color: 'var(--color-neutral-dark)' }}>📚 Lesson Pending</div>
                      )}
